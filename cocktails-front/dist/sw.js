...
class B {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: c, matchOptions: i } = this._strategy, o = await self.caches.open(c), h = this.hasCallback("cacheDidUpdate"), g = h ? await q(
...
se([{"revision":null,"url":"assets/index-e84642f7.css"},{"revision":"276fc7db7989b3d98f6d633a16019a93","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"a7506e4cafdd97de9bffca6c881d53f2","url":"favicon.ico"},{"revision":"5eeabb7705cf44934fb884b8fd7f9ae9","url":"favicon.svg"},{"revision":"3b027d558fe1cbc4eac41f3dc5bbded7","url":"pwa-64x64.png"},{"revision":"57a137639cef2323c56197865a4f4f5d","url":"pwa-192x192.png"},{"revision":"c83ed5c792bd2d34283b4cda67fc69fd","url":"pwa-512x512.png"},{"revision":"df0da4654f41902a415f721bfeb735b1","url":"manifest.webmanifest"}]);
const ae = async (a) => {
  await (await caches.open("v1")).addAll(a);
};
